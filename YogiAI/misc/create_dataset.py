...
dataset_path = "../../Yoga-82/dataset/"
intermediary_path = "tmp/"
...
if __name__ == "__main__":
    for i in range(len(class_names_82)):
        ...
        os.makedirs(dataset_path + class_name + "/Train/")
        os.makedirs(dataset_path + class_name + "/Test/")
        os.makedirs(dataset_path + class_name + "/Validation/")
